...
public class LineProcessor extends CommandProcessor {
    ...
    public LineProcessor(String commandStatement, CanvasActions canvas)
	...
	Point startPoint = new Point(Integer.parseInt(commandParts[2]),
		Integer.parseInt(commandParts[3]));
	Point endPoint = new Point(Integer.parseInt(commandParts[4]),
