...
public class KeyMapper {
	...
	if (keyCode == null) {
	    LOG.error(StringConstants.NEWLINE + "Cannot find mapping for character: [" + key + "] on this keyboard!");
	    JOptionPane.showMessageDialog(null, StringConstants.NEWLINE + "Cannot find mapping for character: [" + key
		    + "] on this keyboard!", "ERROR", JOptionPane.ERROR_MESSAGE);
	    throw new IllegalArgumentException(StringConstants.NEWLINE + "Cannot find mapping for character: [" + key
		    + "] on this keyboard!");
	}
