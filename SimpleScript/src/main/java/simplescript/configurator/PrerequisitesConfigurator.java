...
public class PrerequisitesConfigurator {
     ...
     */
    public static void configurePrerequisites() {
	try {
    ...
    /**
     * <h1><i>initializeConfigurator</i></h1>
     * <p>
     * <p>
     * {@code private static void initializeConfigurator()}
     * </p>
     * Initializes all the prerequisites for the configurator itself - opens up
     * Notepad, sets up the Robot, environment variables, properties.. </p>
     * 
     * @throws IOException
     * @throws AWTException
